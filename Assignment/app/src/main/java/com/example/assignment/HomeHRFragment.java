...
public class HomeHRFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        taskList.add(new Task("Xóa nhân viên", R.drawable.task_xoanhanvien, "Xóa tài khoản của nhân viên bị cho thôi việc"));
        taskList.add(new Task("Tình trạng đơn xin phép công ty",R.drawable.task_tinhtrangdonxinphep,
                "Kiểm tra, theo dõi tình trạng các đơn xin phép của toàn bộ công ty"));
        taskList.add(new Task("Kết quả điểm danh công ty", R.drawable.task_tomtat,
                "Theo dõi kết quả điểm danh của toàn bộ nhân viên trong công ty."));
